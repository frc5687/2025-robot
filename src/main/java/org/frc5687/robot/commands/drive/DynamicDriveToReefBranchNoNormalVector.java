...
public class DynamicDriveToReefBranchNoNormalVector extends DriveToPoseSmooth {

    public DynamicDriveToReefBranchNoNormalVector(DriveSubsystem drive, ReefSide side) {
        super(
                drive,
                () -> {
