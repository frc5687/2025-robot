...
public class RobotState {
    ...
    private RobotState(SwerveDriveKinematics kinematics, Rotation2d gyroAngle, 
            SwerveModulePosition[] initialPositions, Pose2d initialPose) {
    ...
    public static void createInstance(SwerveDriveKinematics kinematics, Rotation2d gyroAngle,
            SwerveModulePosition[] initialPositions, Pose2d initialPose) {
