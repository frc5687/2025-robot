...
public class SuperstructureGoals {
    ...
    public static final SuperstructureState SAFE_CORAL_TRANSITION =
            new SuperstructureState(ElevatorState.STOWED, CoralState.STOWED, AlgaeState.IDLE);

    public static final SuperstructureState RECEIVE_FROM_FUNNEL =
            new SuperstructureState(
                    ElevatorState.FUNNEL_RECEIVE, CoralState.RECEIVE_FROM_FUNNEL, AlgaeState.IDLE);
    public static final SuperstructureState RECEIVE_FROM_INTAKE =
            new SuperstructureState(
                    ElevatorState.STOWED, CoralState.RECEIVE_FROM_INTAKE, AlgaeState.IDLE);

    public static final SuperstructureState PLACE_CORAL_L4 =
            new SuperstructureState(ElevatorState.L4_CORAL_PLACING, CoralState.PLACING, AlgaeState.IDLE);
    public static final SuperstructureState PLACE_CORAL_L4_ALGAE_GRAB =
            new SuperstructureState(
                    ElevatorState.L4_CORAL_PLACING, CoralState.PLACING, AlgaeState.REEF_PICKUP);

    public static final SuperstructureState PLACE_CORAL_L3 =
            new SuperstructureState(ElevatorState.L3_CORAL_PLACING, CoralState.PLACING, AlgaeState.IDLE);
    public static final SuperstructureState PLACE_CORAL_L3_ALGAE_GRAB =
            new SuperstructureState(
                    ElevatorState.L3_CORAL_PLACING, CoralState.PLACING, AlgaeState.REEF_PICKUP);

    public static final SuperstructureState PLACE_CORAL_L2 =
            new SuperstructureState(ElevatorState.L2_CORAL_PLACING, CoralState.PLACING, AlgaeState.IDLE);

    public static final SuperstructureState L1_ALGAE_GRAB =
            new SuperstructureState(
                    ElevatorState.L1_ALGAE_GRAB, CoralState.IDLE_NO_CORAL, AlgaeState.REEF_PICKUP);
    public static final SuperstructureState L2_ALGAE_GRAB =
            new SuperstructureState(
                    ElevatorState.L2_ALGAE_GRAB, CoralState.IDLE_NO_CORAL, AlgaeState.REEF_PICKUP);
}
