...
public class ClimberOutputs extends BaseOutputs {
    ...
    @Logged(name = "Winch output voltage (V)", importance = Logged.Importance.CRITICAL)
    public double winchVoltage = 0;

    @Logged(name = "Servo Setpoint (0.0-1.0)", importance = Logged.Importance.CRITICAL)
    public double servoSetpoint = 0.6;

    @Logged(name = "Climber Voltage", importance = Logged.Importance.CRITICAL)
