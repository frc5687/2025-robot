...
import org.frc5687.robot.commands.drive.DriveToQuickPick;
        ...
        _driverController
                ...
                .whileTrue(
                        ...
                        new SequentialCommandGroup(
                                ...
                                new DriveToQuickPick(container.getDrive(), ReefSide.QUICK_PICK),
                                new DynamicDriveToReefBranchAlgae(container.getDrive(), ReefSide.QUICK_PICK)));
        //           new EjectCoral(container.getCoral()),
        //        getDriverController().povDown()),
